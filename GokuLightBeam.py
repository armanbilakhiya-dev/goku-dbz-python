...
def main():
    ...
    cap_energy = cv2.VideoCapture(r'C:\Users\arman\OneDrive\Desktop\Project Amrin\Goku Light Beam\Assets\energy.mp4')
    
    cap_kame = cv2.VideoCapture(r'C:\Users\arman\OneDrive\Desktop\Project Amrin\Goku Light Beam\Assets\kamehameha.mp4')
    
    options = PoseLandmarkerOptions(
        base_options=BaseOptions(
            model_asset_path=r'C:\Users\arman\OneDrive\Desktop\Project Amrin\Goku Light Beam\pose_landmarker_heavy.task'
            ),
